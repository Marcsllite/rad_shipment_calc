...
create table if not exists SHIPMENT (Id bigint auto_increment, Reference_Date date not null, Mass decfloat(2) not null default '-Infinity', Mass_Prefix char(10) not null default '', Mass_Unit char(10) not null default 'grams (g)', Nature char(10) not null default 'regular', State char(6) not null default 'solid', Form char(7) not null default 'normal', version bigint default 0, primary key (Id));
