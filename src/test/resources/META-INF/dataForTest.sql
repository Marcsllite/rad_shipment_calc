...
create table if not exists A_ONE (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists A_TWO (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists DECAY_CONSTANT (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists EXEMPT_CONCENTRATION (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists EXEMPT_LIMIT (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists HALF_LIFE (Symbol char(2) not null, Mass_Number char(15) not null, Val decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));

create table if not exists LIMITS (State char(6) not null, Form char(7) not null, IA_Limited decfloat(2) not null default '-Infinity', IA_Package decfloat(2) not null default '-Infinity', Limited decfloat(2) not null default '-Infinity', version bigint default 0, primary key (State, Form));

create table if not exists REPORTABLE_QUANTITY (Symbol char(2) not null, Mass_Number char(15) not null, Ci decfloat(2) not null default '-Infinity', TBq decfloat(2) not null default '-Infinity', version bigint default 0, primary key (Symbol, Mass_Number));
...
insert into A_ONE(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into A_TWO(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into DECAY_CONSTANT(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into EXEMPT_CONCENTRATION(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into EXEMPT_LIMIT(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into HALF_LIFE(Symbol, Mass_Number, Val, version) values('Bs', 1, 4.0, -1);
insert into REPORTABLE_QUANTITY(Symbol, Mass_Number, Ci, TBq, version) values('Bs', 1, 4, 0.074, -1);
