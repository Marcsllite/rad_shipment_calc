...
public class ImageHandler {
  ...
  public static Image getShipmentImage(String color) throws InvalidParameterException {
    ...
    if (color.equals(App.getString("umlBlue"))) return new Image("/images/color_single_box.png"); 
    if (color.equals(App.getString("defaultWhite"))) return new Image("/images/white_single_box.png"); 
    if (color.equals(App.getString("defaultGrey"))) return new Image("/images/grey_single_box.png"); 
  ...
  public static Image getReferenceImage(String color) throws InvalidParameterException {
    ...
    if (color.equals(App.getString("umlBlue"))) return new Image("/images/color_paper.png"); 
    if (color.equals(App.getString("defaultWhite"))) return new Image("/images/white_paper.png"); 
    if (color.equals(App.getString("defaultGrey"))) return new Image("/images/grey_paper.png");
