create table if not exists A_ONE (
Abbr char(15) not null,
Val real
version bigint default 0,
primary key (Abbr)
) as select * from csvread('classpath:csv/A1(TBq).csv');

create table if not exists A_TWO (
Abbr char(15) not null,
Val real,
version bigint default 0,
primary key (Abbr)
...
create table if not exists DECAY_CONSTANT (
Abbr char(15) not null,
Val real,
version bigint default 0,
primary key (Abbr)
...
create table if not exists EXEMPT_CONCENTRATION (
Abbr char(15) not null,
Val real,
version bigint default 0,
primary key (Abbr)
...
create table if not exists EXEMPT_LIMIT (
Abbr char(15) not null,
Val real,
version bigint default 0,
primary key (Abbr)
...
Limited real,
version bigint default 0,
primary key (State, Form)
) as select * from csvread('classpath:csv/Limits.csv');

create table if not exists REPORTABLE_QUANTITY (
Abbr char(15) not null,
Ci real,
TBq real,
version bigint default 0,
